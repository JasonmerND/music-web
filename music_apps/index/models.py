...
class Song(models.Model):
    ...
    song_name = models.CharField('歌曲名', max_length=50)
    song_singer = models.CharField('歌手名', max_length=50)
    song_time = models.CharField('歌曲时长', max_length=10)
    song_album = models.CharField('专辑名', max_length=50)
    ...
    song_img = models.CharField('歌曲图片', max_length=50)
    song_lyrics = models.CharField('歌曲歌词', max_length=50, default='暂无歌词')
...
class Comment(models.Model):
    ...
    comment_user = models.CharField("用户名", max_length=20)
    song = models.ForeignKey(Song, on_delete=models.CASCADE, verbose_name = "歌名")
    comment_date = models.CharField("评论日期", max_length=50)
